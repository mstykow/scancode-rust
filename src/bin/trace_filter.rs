...
fn main() {
    ...
    if let Some(m) = unicode_3 {
        println!("unicode_3 (seq): qstart={}, end_token={}, hilen={}, matched_len={}, matcher_order={}", 
            m.qstart(), m.end_token, m.hilen, m.matched_length, m.matcher_order());
    }
    if let Some(m) = unicode_40 {
        println!("unicode_40 (aho): qstart={}, end_token={}, hilen={}, matched_len={}, matcher_order={}", 
            m.qstart(), m.end_token, m.hilen, m.matched_length, m.matcher_order());
    }
    if let Some(m) = unicode_42 {
        println!("unicode_42 (aho): qstart={}, end_token={}, hilen={}, matched_len={}, matcher_order={}", 
            m.qstart(), m.end_token, m.hilen, m.matched_length, m.matcher_order());
    }
