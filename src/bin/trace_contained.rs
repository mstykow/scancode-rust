...
fn main() {
    ...
    println!(
        "unicode_3 (seq): sort tuple = ({}, {}, {}, {})",
        unicode_3.qstart(),
        unicode_3.hilen,
        unicode_3.matched_length,
        unicode_3.matcher_order()
    );
    println!(
        "unicode_40 (aho): sort tuple = ({}, {}, {}, {})",
        unicode_40.qstart(),
        unicode_40.hilen,
        unicode_40.matched_length,
        unicode_40.matcher_order()
    );
    println!(
        "unicode_42 (aho): sort tuple = ({}, {}, {}, {})",
        unicode_42.qstart(),
        unicode_42.hilen,
        unicode_42.matched_length,
        unicode_42.matcher_order()
    );

    println!("\n=== CONTAINMENT CHECK ===");
    println!(
        "unicode_3.qcontains(unicode_40): {}",
        unicode_3.qcontains(unicode_40)
    );
    println!(
        "unicode_3.qcontains(unicode_42): {}",
        unicode_3.qcontains(unicode_42)
    );
    ...
    println!(
        "unicode_3 qspan contains unicode_40 qspan: {}",
        u3_contains_u40
    );
    println!(
        "unicode_3 qspan contains unicode_42 qspan: {}",
        u3_contains_u42
    );

    println!(
        "\nunicode_3 qspan: {} positions (first 10: {:?})",
        u3_qspan.len(),
        &u3_qspan[..u3_qspan.len().min(10)]
    );
    println!(
        "unicode_40 qspan: {} positions (first 10: {:?})",
        u40_qspan.len(),
        &u40_qspan[..u40_qspan.len().min(10)]
    );
    println!(
        "unicode_42 qspan: {} positions (first 10: {:?})",
        u42_qspan.len(),
        &u42_qspan[..u42_qspan.len().min(10)]
    );
}
