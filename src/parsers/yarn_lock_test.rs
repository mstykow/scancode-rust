  ...
  "peerDependenciesMeta": {
    "react": {
      "optional": true
        ...
        assert_eq!(chai_dep.scope, Some("dependencies".to_string()));
        assert_eq!(chai_dep.is_runtime, Some(true));
        assert_eq!(chai_dep.is_optional, Some(false));
        assert_eq!(chai_dep.is_direct, Some(false));
    }
