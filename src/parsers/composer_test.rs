...
"#;
    ...
    #[test]
    fn test_normalize_single_spdx_license() {
        let content = r#"
{
  "name": "acme/demo",
  "license": "MIT"
...
"#;
    ...
    #[test]
    fn test_normalize_spdx_license_array_as_or_expression() {
        let content = r#"
{
  "name": "acme/demo",
...
"#;
        ...
        assert_eq!(
            package_data.extracted_license_statement.as_deref(),
            Some("LGPL-2.1-only OR GPL-3.0-or-later")
        );
        assert_eq!(
            package_data.declared_license_expression.as_deref(),
            Some("lgpl-2.1-only OR gpl-3.0-or-later")
    ...
    #[test]
    fn test_normalize_spdx_license_expression_string() {
        let content = r#"
{
  "name": "acme/demo",
...
"#;
    ...
    #[test]
    fn test_normalize_proprietary_license_special_case() {
        let content = r#"
{
  "name": "acme/demo",
  "license": "proprietary"
...
"#;
        ...
        assert_eq!(
            package_data.declared_license_expression_spdx.as_deref(),
            Some("LicenseRef-provenant-proprietary-license")
        );
    }

    #[test]
    fn test_custom_license_text_stays_raw_only() {
        let content = r#"
{
  "name": "acme/demo",
...
"#;
    ...
    #[test]
    fn test_single_non_spdx_token_stays_raw_only() {
        let content = r#"
{
  "name": "acme/demo",
  "license": "Commercial"
...
"#;
    ...
    #[test]
    fn test_mixed_license_array_stays_raw_only() {
        let content = r#"
{
  "name": "acme/demo",
...
"#;
    ...
    #[test]
    fn test_mixed_license_expression_stays_raw_only() {
        let content = r#"
{
  "name": "acme/demo",
