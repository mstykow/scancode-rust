//! Parser for Swift Package.swift.json and Package.swift.deplock manifest files.
...
impl PackageParser for SwiftManifestJsonParser {
    ...
    fn is_match(path: &Path) -> bool {
        path.file_name()
            ...
            .is_some_and(|name| name == "Package.swift.json" || name == "Package.swift.deplock")
    }
}
...
crate::register_parser!(
    "Swift Package.swift.json manifest (JSON dump of Package.swift)",
