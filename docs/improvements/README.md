...
| [Ruby](ruby-parser.md)                                  | 🐛 Bug Fix + ✨ New Feature + 🔍 Enhanced | External gemspec constants unresolved, extracted gem duplication, and thin proof for Bundler source metadata                           | Added required-file constant resolution, Git/PATH parser goldens, extracted-gem merge dedupe, and nested Ruby file-to-package assignment                                            | Better Ruby gemspec parity, cleaner extracted-gem results, and stronger Bundler source provenance    |
...
- **[ruby-parser.md](ruby-parser.md)** — 🐛 Bug Fix + ✨ New Feature + 🔍 Enhanced Extraction: required-file constant resolution, Bundler source metadata proof, and extracted-gem merge/resource assignment
