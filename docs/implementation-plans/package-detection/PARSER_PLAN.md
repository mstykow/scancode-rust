...
| Python/PyPI           | ✅ Implemented | Consolidates many handlers, includes `pip-inspect.deplock`                       |
...
| --------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| #118      | Python UV manifests (`uv.lock`) | Extends the already mature Python parser family with a modern workflow that is increasingly visible in Python repositories and likely improves dependency recovery. | Strong adjacency to existing PyPI parsing and lockfile handling.                                |
