...
| ----- | --------------------- | ----------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1     | Maven                 | In progress | #122, #124, #126, #128, #131, #135, #207, #208, #211, #214                                                 | `cargo test maven`; `cargo test --features golden-tests maven_golden`; `cargo test --features golden-tests test_assembly_maven_basic`; targeted nested `META-INF/maven/**` regression coverage before closing all linked issues                                                                                                                                                |
...
- The Maven ecosystem batch already covers #124, #126, #128, #131, #208, and #214 with parser, unit-test, parser-golden, assembly-golden, and improvement-doc updates.
- Do not treat #122, #135, #207, and #211 as fully closeable until the branch also proves XML-comment license handling, explicit nested `META-INF/maven/**/pom.xml` validation, and targeted role-spelling regressions.
- For #135 and #207, require dedicated nested `META-INF/maven/<group>/<artifact>/pom.xml` fixture coverage instead of relying only on the existing `maven-basic` root-`pom.xml` assembly case.
